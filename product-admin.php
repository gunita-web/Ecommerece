...
<a class="navbar-brand" href="index.php">BestStore.com</a>
...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
    ...
    <a class="nav-link" href="signup/registration.php">

<i class="fa fas fa-user"></i>

<span class="nav-link-te xt">Register Users</span>
...
<a class="btn btn-primary" href='http://localhost/Php_project/login/loginapi.php';>Logout</a>
